...
(function() {
  ...
  Dashing.Departure = (function(_super) {
    ...
    Departure.accessor('j_value', Dashing.AnimatedValue);

    Departure.accessor('w_value', Dashing.AnimatedValue);

    Departure.accessor('y_value', Dashing.AnimatedValue);

    Departure.accessor('total_value', Dashing.AnimatedValue);

    Departure.prototype.ready = function() {
      this.observe('j_value', function(j_value) {
        var j_color, j_meter, max;
        j_meter = $(this.node).find("#j_booked_meter");
        max = parseInt($(this.node).find("#j_booked_meter").attr("data-max")) + 5;
        ...
        j_meter.val(j_value).trigger('configure', {
          fgColor: j_color
        });
        j_meter.attr("data-max", max);
        j_meter.knob();
        return j_meter.val(j_value).trigger('change');
      });
      this.observe('w_value', function(w_value) {
        var max, w_color, w_meter;
        w_meter = $(this.node).find("#w_booked_meter");
        max = parseInt($(this.node).find("#w_booked_meter").attr("data-max")) + 10;
        ...
        w_meter.val(w_value).trigger('configure', {
          fgColor: w_color
        });
        w_meter.attr("data-max", max);
        w_meter.knob();
        return w_meter.val(w_value).trigger('change');
      });
      this.observe('y_value', function(y_value) {
        var max, y_color, y_meter;
        y_meter = $(this.node).find("#y_booked_meter");
        max = parseInt($(this.node).find("#y_booked_meter").attr("data-max")) + 20;
        ...
        y_meter.val(y_value).trigger('configure', {
          fgColor: y_color
        });
        y_meter.attr("data-max", max);
        y_meter.knob();
        return y_meter.val(y_value).trigger('change');
      });
      return this.observe('total_value', function(total_value) {
        var max, total_color, total_meter;
        total_meter = $(this.node).find("#total_booked_meter");
        max = parseInt($(this.node).find("#total_booked_meter").attr("data-max")) + 25;
        ...
        total_meter.val(total_value).trigger('configure', {
          fgColor: total_color
        });
        total_meter.attr("data-max", max);
        total_meter.knob();
        return total_meter.val(total_value).trigger('change');
      });
    };
