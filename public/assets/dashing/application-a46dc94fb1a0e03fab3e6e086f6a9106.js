...
(function() {
  ...
  Dashing.Departure = (function(_super) {
    ...
    Departure.accessor('j_booked_percentage', Dashing.AnimatedValue);

    Departure.accessor('w_booked_percentage', Dashing.AnimatedValue);

    Departure.accessor('y_booked_percentage', Dashing.AnimatedValue);

    Departure.accessor('total_booked_percentage', Dashing.AnimatedValue);
...
(function() {
  ...
  Dashing.Departurenotworking = (function(_super) {
    __extends(Departurenotworking, _super);

    function Departurenotworking() {
      return Departurenotworking.__super__.constructor.apply(this, arguments);
    }

    return Departurenotworking;
