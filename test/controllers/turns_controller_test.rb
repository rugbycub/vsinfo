...
class TurnsControllerTest < ActionController::TestCase
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post :create, turn: { aircraft: @turn.aircraft, arrival: @turn.arrival, departure: @turn.departure, gate: @turn.gate }
    end
  ...
  test "should update turn" do
    patch :update, id: @turn, turn: { aircraft: @turn.aircraft, arrival: @turn.arrival, departure: @turn.departure, gate: @turn.gate }
    assert_redirected_to turn_path(assigns(:turn))
  end
