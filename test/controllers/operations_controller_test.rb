...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { city: @operation.city, date: @operation.date, staff_assignment: @operation.staff_assignment }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { city: @operation.city, date: @operation.date, staff_assignment: @operation.staff_assignment }
    assert_redirected_to operation_path(assigns(:operation))
  end
